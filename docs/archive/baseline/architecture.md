...
- [commandExecutor.ts](./src/services/commandExecutor.ts)
- [insertCommandExecutor.ts](./src/services/insertCommandExecutor.ts)
- [replaceCommandExecutor.ts](./src/services/replaceCommandExecutor.ts)
...
核心文件：
- [useOrchestrator.ts](./src/composables/useOrchestrator.ts)
- [orchestrator.ts](./src/services/orchestrator.ts)
...
核心文件：
- [dataService.ts](./src/services/orchestration/dataService.ts)
- [candidateService.ts](./src/services/candidateService.ts)
- [layoutImportService.ts](./src/services/layoutImportService.ts)
- [runtimeLayoutRegistry.ts](./src/services/orchestration/runtimeLayoutRegistry.ts)
- [demoData.ts](./src/mock/demoData.ts)
- [orchestrationMock.ts](./src/mock/orchestrationMock.ts)
